...
public interface VocabularyToeflDao {
    ...
    @Query("SELECT count(*) FROM vocabulary_toefl WHERE IsSave==1")
    int getNumberSavedVocabularyToefl();

    @Query("SELECT count(*) FROM vocabulary_toefl")
    int getNumberVocabularyToefl();
